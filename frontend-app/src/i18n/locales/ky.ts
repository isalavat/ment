export const ky = {
  ...
  verification: {
    pendingBanner: "Сиздин ментор профилиңиз администратордун текшерүүсүн күтүп жатат. Текшерилгенге чейин издөө жыйынтыктарынан табылбайсыз.",
    ...
    incompleteBanner: "Сиздин ментор профилиңиз азырынча толтурулган жок. Текшерүүгө жөнөтүү үчүн бардык керектүү маалыматты толтуруңуз.",
    verifiedBanner: "Профилиңиз текшерилди жана жеткиликтүүлүгүңүздү коюп койгондон кийин издөө жыйынтыктарында пайда болот.",
    pendingIncompleteBanner: "Профилиңиз күтүп жатат, бирок текшерүү үчүн кеминде бир көндүм жана бир категория кошуу керек.",
  },
  auth: {
    login: {
      title: "Кайра Келиңиз",
