export const ru = {
  ...
  verification: {
    pendingBanner: "Ваш профиль ментора ожидает проверки администратором. Вы не будете отображаться в результатах поиска до верификации.",
    rejectedBanner: "Ваш профиль ментора не был одобрен.",
    rejectedReason: "Причина:",
    rejectedContact: "Пожалуйста, обновите свой профиль и обратитесь в поддержку.",
    incompleteBanner: "Ваш профиль ментора ещё не заполнен. Пожалуйста, заполните всю необходимую информацию, чтобы отправить его на верификацию.",
    verifiedBanner: "Ваш профиль верифицирован и появится в результатах поиска после того, как вы укажете своё расписание.",
    pendingIncompleteBanner: "Ваш профиль ожидает проверки, но для верификации необходимо добавить хотя бы один навык и одну категорию.",
  },
  auth: {
    login: {
