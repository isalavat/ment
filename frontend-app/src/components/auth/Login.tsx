...
const QUICK_LOGIN_OPTIONS: QuickLoginOption[] = [
  {
    value: "dev.user@mentorhub.local",
    label: "Demo Learner (USER)",
    email: "dev.user@mentorhub.local",
  },
  {
    value: "dev.mentor@mentorhub.local",
    label: "Demo Mentor (VERIFIED)",
    email: "dev.mentor@mentorhub.local",
  },
  {
    value: "dev.mentor.pending@mentorhub.local",
    label: "Demo Mentor (PENDING PROFILE)",
    email: "dev.mentor.pending@mentorhub.local",
  },
  {
    value: "dev.mentor.noprofile@mentorhub.local",
    label: "Demo Mentor (NO PROFILE)",
    email: "dev.mentor.noprofile@mentorhub.local",
  },
  {
    value: "dev.admin@mentorhub.local",
    label: "Demo Admin (ADMIN)",
    email: "dev.admin@mentorhub.local",
  },
];

const QUICK_LOGIN_PASSWORD =
  process.env.REACT_APP_TEST_USERS_PASSWORD || "Test@1234";
...
export const Login: React.FC = () => {
  ...
  const handleQuickLoginSelect = async (
    ...
    const option = QUICK_LOGIN_OPTIONS.find(
          ...
          {QUICK_LOGIN_ENABLED && (
            <div className="form-group">
              ...
              <p className="auth-helper-text">
                Available only in development and test builds.
              </p>
            </div>
          )}
