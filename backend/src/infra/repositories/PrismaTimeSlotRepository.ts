...
export class PrismaTimeSlotRepository implements TimeSlotRepository {
	...
	async findByMentorAndRange(mentorId: string, startTime: Date, endTime: Date): Promise<TimeSlotRecord | null> {
	...
	async findBlockedOverlap(mentorId: string, startTime: Date, endTime: Date): Promise<{ id: string } | null> {
