...
router.patch(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const booking = await bookingService.cancelBookingByMentee(
        bookingId,
        menteeId
      );
      res.json(booking);
...
router.patch(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const booking = await bookingService.cancelBookingByMentor(
        bookingId,
        mentorId
      );
      res.json(booking);
...
router.patch(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const booking = await bookingService.updateMeetingLink(
        bookingId,
        mentorId,
        meetingLink
      );
