...
router.post("/", async (req: Request, res: Response, next: NextFunction) => {
	try {
		const { mentorId, dayOfWeek, startTime, endTime, isRecurring, specificDate } = req.body;
 ...
 */
router.get("/mentor/:mentorId/recurring", async (req: Request, res: Response, next: NextFunction) => {
	try {
		const mentorId = req.params.mentorId;
 ...
 */
router.get("/mentor/:mentorId/specific", async (req: Request, res: Response, next: NextFunction) => {
	try {
		const mentorId = req.params.mentorId;
