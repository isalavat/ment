...
mentorController.get("/mentors/by-user/:userId", async (req: AuthedRequest, res: Response) => {
...
mentorController.get("/mentors/:id", async (req: AuthedRequest, res: Response) => {
...
mentorController.put("/mentors/by-user/:userId", async (req: AuthedRequest, res: Response) => {
...
mentorController.post("/mentors/by-user/:userId", async (req: AuthedRequest, res: Response) => {
	const { bio, title, yearsExperience, hourlyRate, currency } = req.body;
...
mentorController.post("/mentors/by-user/:userId/skills", async (req: AuthedRequest, res: Response) => {
...
mentorController.delete("/mentors/by-user/:userId/skills/:skillId", async (req: AuthedRequest, res: Response) => {
...
mentorController.post("/mentors/by-user/:userId/categories", async (req: AuthedRequest, res: Response) => {
