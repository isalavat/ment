...
menteeController.get("/mentees", async (_req: AuthedRequest, res: Response) => {
...
menteeController.get("/mentees/by-user/:userId", async (req: AuthedRequest, res: Response) => {
...
menteeController.post("/mentees/by-user/:userId", async (req: AuthedRequest, res: Response) => {
...
menteeController.put("/mentees/by-user/:userId", async (req: AuthedRequest, res: Response) => {
	const { bio, goals } = req.body;
